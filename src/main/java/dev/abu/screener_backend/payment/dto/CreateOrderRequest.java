 ...
 *
 * <p>{@code amount} is a <strong>string</strong>, parsed to {@code BigDecimal} server-side (E10): a
 * JSON number can lose precision when a client serialises it from a {@code double}, which matters for

 ...
 */
@Configuration
@EnableConfigurationProperties({BinanceApiProperties.class, WebSocketProperties.class, DisruptorProperties.class, OrderbookProperties.class, JwtProperties.class, AdminProperties.class, BillingProperties.class, PaymentProperties.class, EmailProperties.class, MonitoringProperties.class})
